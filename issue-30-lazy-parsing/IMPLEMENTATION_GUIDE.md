...
- **Don't** read the 20+ historical docs in this folder
...
If you need context on why we're NOT doing lazy parsing, see `archive/failed-attempts/`. Otherwise, focus on the tasks above.
